...
3. The users will also set `trustStrimziCaCertificate` field to specify if they want to trust the certificates generated by Strimzi or not.
...
|---------------------------------|-----------------------------|-------------------------------------------------|------------------------------------------------------------|
| private CA                      | provided                    | value ignored                                   | Use the certificate provided in `spec.tls.trustAnchorRef`. |
| Strimzi issued CA (development) | not provided                | true                                            | Trust the generated Strimzi CA certificate and use them.   |
| public CA                       | not provided                | value ignored                                   | Using public CA.                                           |
