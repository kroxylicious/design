...
| if spec.strimziKafkaRef.trustStrimziCaCertificate? | if spec.tls.trustAnchorRef? | Outcome                                                    |
|----------------------------------------------------|-----------------------------|------------------------------------------------------------|
| true                                               | true                        | Use the certificate provided in `spec.tls.trustAnchorRef`. |
| true                                               | false                       | Trust the generated Strimzi CA certificate and use them.   |
| false                                              | true                        | Use the certificate provided in `spec.tls.trustAnchorRef`. |
| false                                              | false                       | Throw error condition in the Kafka Service CR status       |
